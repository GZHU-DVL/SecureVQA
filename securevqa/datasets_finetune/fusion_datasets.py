...
class FusionDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        guardian = (2 * np.random.randint(0, 2, size=(Intra_data['fragments'].shape[0] * (Intra_data['fragments'].shape[2]) * (Intra_data['fragments'].shape[3]))) - 1)  # Initialized guardian map from {-1,1}
